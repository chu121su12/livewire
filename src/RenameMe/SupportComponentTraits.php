...
class SupportComponentTraits
{
    ...
    function __construct()
    {
        ...
        Livewire::listen('component.mount', function ($component, $params) {
            $methods = isset($this->componentIdMethodMap[$component->id]) && isset($this->componentIdMethodMap[$component->id]['mount']) ? $this->componentIdMethodMap[$component->id]['mount'] : [];
        ...
        Livewire::listen('component.updating', function ($component, $name, $value) {
            $methods = isset($this->componentIdMethodMap[$component->id]) && isset($this->componentIdMethodMap[$component->id]['updating']) ? $this->componentIdMethodMap[$component->id]['updating'] : [];
        ...
        Livewire::listen('component.updated', function ($component, $name, $value) {
            $methods = isset($this->componentIdMethodMap[$component->id]) && isset($this->componentIdMethodMap[$component->id]['updated']) ? $this->componentIdMethodMap[$component->id]['updated'] : [];
        ...
        Livewire::listen('component.rendering', function ($component) {
            $methods = isset($this->componentIdMethodMap[$component->id]) && isset($this->componentIdMethodMap[$component->id]['rendering']) ? $this->componentIdMethodMap[$component->id]['rendering'] : [];
        ...
        Livewire::listen('component.rendered', function ($component, $view) {
            $methods = isset($this->componentIdMethodMap[$component->id]) && isset($this->componentIdMethodMap[$component->id]['rendered']) ? $this->componentIdMethodMap[$component->id]['rendered'] : [];
        ...
        Livewire::listen('component.dehydrate', function ($component) {
            $methods = isset($this->componentIdMethodMap[$component->id]) && isset($this->componentIdMethodMap[$component->id]['dehydrate']) ? $this->componentIdMethodMap[$component->id]['dehydrate'] : [];
